...
const Navbar = () => {
    const HandleSidebarState = () => {
        ...
        const checkbox = document.querySelector("#sidebar_checkbox")
        if (!checkbox.checked) {
            sidebar.classList.add("opened_sidebar")
            sidebarBtn.classList.add("sidebar_burger_to_close")
            checkbox.checked = true
        } else {
            sidebar.classList.remove("opened_sidebar")
            sidebarBtn.classList.remove("sidebar_burger_to_close")
        ...
        <div className={classes.navbar}>
            <div className={classes.menu_toggle}>
                <button
                    ...
                    className={classes.sidebar_burger}
                >
            ...
            <button onClick={HandleOpenModal} className={classes.setting_a}>
                <svg
